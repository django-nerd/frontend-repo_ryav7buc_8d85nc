      ...
      <nav className="mx-auto max-w-7xl px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/60 leading-none mt-0.5">Fair launch on pump.fun — Solana</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden sm:inline-flex items-center gap-2 rounded-full bg-white text-slate-900 px-4 py-2 text-sm font-semibold hover:bg-slate-100 transition-colors"
          >
            Buy on pump.fun
          </a>
